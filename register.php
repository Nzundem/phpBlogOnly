            ...
            <form role="form text-center">
                        <div class="row ">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <button type="submit" class="btn btn-default col-lg-2" id="register">Register</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="col-lg-12">
                    <div class="col-lg-5"></div>
                    <a href="login.php" ><button type="submit" class="btn btn-default col-lg-2">Login</button></a>       
                     </div>
        </div>
    </div>
</div>
